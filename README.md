# 5374 福島県福島市版
2018.9.18 平成29年度ごみ収集日程を公開<br>
福島市が公開しているデータを使い「ふくしまIoTビジネス共創ラボ 公共ワーキンググループ」がアプリに実装しました。

## ふくしまIoTビジネス共創ラボ 公共ワーキンググループ
福島をIoTで盛り上げる。<br>
市民の声、職員様の声に耳を傾け、ICTを利用した課題解決を行う活動を行っています。
